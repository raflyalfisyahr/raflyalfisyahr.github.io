...
function LightTheme(target){
    ...
    autoFetch(e=>{
        if(e.data.length > 0){
            ...
            document.querySelectorAll('.download-info').forEach(e=> e.style.backgroundColor = '#fafafa')
            document.querySelectorAll('.date-download').forEach(e=>e.style.color = 'rgba(91,91,255,1)')
            document.querySelectorAll('.link-download').forEach(e=>e.style.backgroundColor = 'rgba(91,91,255,1)')
        }
    })    
...
function DarkTheme(target){
    ...
    autoFetch(e=>{
        if(e.data.length > 0){
            document.querySelectorAll('.download-info').forEach(e => e.style.backgroundColor = '#191919')
            document.querySelectorAll('.date-download').forEach(e=> e.style.color = '#fafafa')
            document.querySelectorAll('.link-download').forEach(e=> e.style.backgroundColor = 'rgb(60, 60, 60)')
        }
    })
